...
class UmDocumentDownloadComponent < Arclight::DocumentDownloadComponent
  ...
  # From https://icons.getbootstrap.com/icons/file-earmark-pdf/
  def pdf_icon
    icon = <<~HTML
  ...
  # From https://icons.getbootstrap.com/icons/file-earmark-code/
  def ead_icon
    icon = <<~HTML
